...
const MyOrdersCard = ({ bookedProduct, setProduct, myorders }) => {
    const { _id, productId, image, productName, Condition, sellerName, description, todayTime, productPrice, location, purchasingPrice } = bookedProduct;
        ...
        <div className='md:w-full lg:w-[420px] mx-auto'>
            <div className={`card  bg-base-100 shadow-xl bg-gradient-to-r from-[#164e63] to-[#0c4a6e] text-slate-50 font-medium`}>
                ...
                <div className="card-body">
                    ...
                    {
                        bookedProduct?.paid ? <button className=" border  rounded-lg pl-2 py-1 w-1/2 mx-auto text-center bg-gradient-to-r from-primary to-secondary text-black ">Paid</button> :
